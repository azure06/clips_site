<template>
  <v-container>
    <v-layout>
      <v-flex pa-6>
        <h3 class="blue-grey--text text--darken-1">Privacy Policy of Clips</h3>
        <p class="body-2 blue-grey--text text--darken-1">
          Clips operates the infiniticlips.com website, which provides the
          SERVICE.
        </p>
        ...
        <p class="body-2 blue-grey--text text--darken-1">
          ...
          anyone decided to use our Service, the infiniticlips.com website.
        </p>
        ...
        <p class="body-2 blue-grey--text text--darken-1">
          ...
          Terms and Conditions, which is accessible at infiniticlips.com, unless
          ...
          >
          plus the
          <a href="https://returnrefundpolicytemplate.com/"
            >Refund Policy Template</a
          >.
        </p>

        <h3 class="blue-grey--text text--darken-1">
        ...
        <h3 class="blue-grey--text text--darken-1">Log Data</h3>
        ...
        <h3 class="blue-grey--text text--darken-1">Cookies</h3>
        ...
        <h3 class="blue-grey--text text--darken-1">Service Providers</h3>
        ...
        <ul>
          <li class="body-2 blue-grey--text text--darken-1">
        ...
        <h3 class="blue-grey--text text--darken-1">Security</h3>
        ...
        <h3 class="blue-grey--text text--darken-1">Links to Other Sites</h3>
        ...
        <h3 class="blue-grey--text text--darken-1">Children’s Privacy</h3>
        ...
        <h3 class="blue-grey--text text--darken-1">Contact Us</h3>
